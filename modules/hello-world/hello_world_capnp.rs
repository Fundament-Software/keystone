...
pub mod hello_world {
  ...
  pub type SayHelloParams<> = ::capnp::capability::Params<crate::hello_world_capnp::hello_world::say_hello_params::Owned>;
  pub type SayHelloResults<> = ::capnp::capability::Results<crate::hello_world_capnp::hello_world::say_hello_results::Owned>;
  ...
  impl  Client {
    pub fn say_hello_request(&self) -> ::capnp::capability::Request<crate::hello_world_capnp::hello_world::say_hello_params::Owned,crate::hello_world_capnp::hello_world::say_hello_results::Owned> {
  ...
  pub mod hello_request {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 39] = [
        ...
        ::capnp::word(101, 108, 108, 111, 87, 111, 114, 108),
        ::capnp::word(100, 46, 72, 101, 108, 108, 111, 82),
  ...
  pub mod say_hello_params {
    ...
    impl <'a,> Reader<'a,>  {
      ...
      #[inline]
      pub fn get_request(self) -> ::capnp::Result<crate::hello_world_capnp::hello_world::hello_request::Reader<'a>> {
        ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0), ::core::option::Option::None)
      }
      #[inline]
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn get_request(self) -> ::capnp::Result<crate::hello_world_capnp::hello_world::hello_request::Builder<'a>> {
        ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
      }
      #[inline]
      pub fn set_request(&mut self, value: crate::hello_world_capnp::hello_world::hello_request::Reader<'_>) -> ::capnp::Result<()> {
        ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
      }
      #[inline]
      pub fn init_request(self, ) -> crate::hello_world_capnp::hello_world::hello_request::Builder<'a> {
    ...
    impl Pipeline  {
      pub fn get_request(&self) -> crate::hello_world_capnp::hello_world::hello_request::Pipeline {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 39] = [
        ...
        ::capnp::word(46, 99, 97, 112, 110, 112, 58, 72),
        ::capnp::word(101, 108, 108, 111, 87, 111, 114, 108),
        ::capnp::word(100, 46, 115, 97, 121, 72, 101, 108),
        ::capnp::word(108, 111, 36, 80, 97, 114, 97, 109),
      ...
      pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
        match index {
          0 => <crate::hello_world_capnp::hello_world::hello_request::Owned as ::capnp::introspect::Introspect>::introspect(),
          _ => panic!("invalid field index {}", index),
        }
      }
      pub fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
  ...
  pub mod say_hello_results {
    ...
    impl <'a,> Reader<'a,>  {
      ...
      #[inline]
      pub fn get_reply(self) -> ::capnp::Result<crate::hello_world_capnp::hello_world::hello_reply::Reader<'a>> {
        ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0), ::core::option::Option::None)
      }
      #[inline]
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn get_reply(self) -> ::capnp::Result<crate::hello_world_capnp::hello_world::hello_reply::Builder<'a>> {
        ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
      }
      #[inline]
      pub fn set_reply(&mut self, value: crate::hello_world_capnp::hello_world::hello_reply::Reader<'_>) -> ::capnp::Result<()> {
        ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
      }
      #[inline]
      pub fn init_reply(self, ) -> crate::hello_world_capnp::hello_world::hello_reply::Builder<'a> {
        ::capnp::traits::FromPointerBuilder::init_pointer(self.builder.get_pointer_field(0), 0)
      }
      #[inline]
      pub fn has_reply(&self) -> bool {
    ...
    impl Pipeline  {
      pub fn get_reply(&self) -> crate::hello_world_capnp::hello_world::hello_reply::Pipeline {
        ::capnp::capability::FromTypelessPipeline::new(self._typeless.get_pointer_field(0))
      }
    }
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 39] = [
        ...
        ::capnp::word(101, 108, 108, 111, 87, 111, 114, 108),
        ::capnp::word(100, 46, 115, 97, 121, 72, 101, 108),
        ::capnp::word(108, 111, 36, 82, 101, 115, 117, 108),
      ...
      pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
        match index {
          0 => <crate::hello_world_capnp::hello_world::hello_reply::Owned as ::capnp::introspect::Introspect>::introspect(),
          _ => panic!("invalid field index {}", index),
        }
      }
      pub fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
